            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex gap-2 mb-6">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === 'slots'
                                ? 'bg-primary-600 text-white'
                                : 'bg-white text-secondary-700 hover:bg-secondary-100'
                            }`}
                    >
                                ...
                                <div className="space-y-3">
                                    {DAYS_OF_WEEK.map(day => {
                                        ...
                                        return (
                                            <div
                                                key={day}
                                                className={`p-3 rounded-lg ${hasSlots ? 'bg-green-50' : 'bg-secondary-50'
                                                    }`}
                                            >
                                                <div className="flex items-center justify-between mb-2">
                                                    <span className={`font-medium ${hasSlots ? 'text-green-700' : 'text-secondary-400'}`}>
                                                        {formatDay(day)}
                                                    </span>
                                                    {!hasSlots && (
                                                ...
                                                {hasSlots && (
                                                    <div className="space-y-2 ml-4">
                                                        {daySlots.map((slot, index) => (
                                                            <div key={slot.id || index} className="flex items-center justify-between bg-white p-2 rounded-lg shadow-sm">
                                        ...
                                        <div key={date}>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {dateSlots.map(slot => (
                                                    <div
                                                        key={slot.id}
                                                        className={`px-3 py-2 rounded-lg text-sm ${slot.isBooked
